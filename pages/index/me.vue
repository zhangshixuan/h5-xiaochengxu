		...
		<view class='UCenter-bg' :style="'background-image: url(' + pic[topBackGroupImageIndex].link + ');margin-top:-' + CustomBar + 'px;'">
			...
			<block>
				<view class='text-center'>
					<!-- <view class="cu-avatar2 round margin-right-sm shadow-blur bg-img" style="background-image:url(https://cdn.zhangshixuan925.top/head1.jpg);">
					</view> -->
	...
	export default {
		data() {
			return {
				...
				picName: '流星之夜',
				pic: [{
					link: 'https://cdn.zhangshixuan925.top/zjx_me_bg1.jpeg',
					name: '春天'
				}, {
					link: 'https://cdn.zhangshixuan925.top/zjx_me_bg2.jpeg',
					name: '夏天'
				}, {
					link: 'https://cdn.zhangshixuan925.top/zjx_me_bg3.jpeg',
					name: '秋天'
				}, {
					link: 'https://cdn.zhangshixuan925.top/zjx_me_bg4.jpeg',
					name: '冬天'
				}, {
					link: 'https://cdn.zhangshixuan925.top/zjx_me_bg5.jpeg',
					name: '幽静'
				}, {
					link: 'https://cdn.zhangshixuan925.top/zjx_me_bg6.jpg',
					name: '天空'
				}],
...
<style lang="scss" scoped>
	...
	.modal_bg {
		...
		position: absolute;
		top: -100rpx;
		background-image: url(https://cdn.zhangshixuan925.top/modal_bg.png);
		background-size: 100%;
