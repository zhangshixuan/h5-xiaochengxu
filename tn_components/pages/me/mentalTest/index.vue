...
<template>
	<view class="contaier" :style="{ minHeight: getHeight + 'px' }">
		...
		<view class="bannerBox">
			<image class="ggBox" mode="widthFix" src="https://cdn.zhangshixuan925.top/Banner3.jpg"></image>
		</view>
		
		<!-- 答题主页面 -->
		<view class="padding">
			<view class="mainBox radius shadow-warp bg-white margin-top relative">
				<view class="userHeard cu-avatar lg round" style="background-image:url(https://cdn.zhangshixuan925.top/logo.png);"></view>
				<view v-show="hasData">
		...
		<u-mask :show="show">
			<view class="warp">
				<view class="rect" @tap.stop>
					...
					<view class="closeImg">
						<image mode="aspectFit" src="https://cdn.zhangshixuan925.top/answerTrophy.png"></image>
					</view>
...
<style lang="scss" scoped>
	...
	.mentalListActive {
		...
		margin: 30rpx 0;
		font-weight: 600;
		background-image: url(https://cdn.zhangshixuan925.top/answerYes.png);
