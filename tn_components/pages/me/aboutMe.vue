...
<template>
  <view class="about">
    ...
    <button class='' open-type="contact">
      <image src='https://cdn.zhangshixuan925.top/logo.png' class='share-img png round shadow-lg bg-white' mode='aspectFit'>
      </image>
    </button>
  </view>
</template>
...
<script>
  import LikeFx from '@/tn_components/components/likeFx/likeFx.vue'
  export default {
    components: {
      LikeFx
    },
