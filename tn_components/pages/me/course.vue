				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;">
						<view class="page-box">
							<view>
								<view class="centre">
									<image src="https://cdn.zhangshixuan925.top/noData1.png" mode="widthFix"></image>
									<view class="explain">
										暂无班级信息
			...
			dataList: [
				{
					...
					goodsList: [
						{
							goodsUrl: 'https://cdn.zhangshixuan925.top/web2.jpg',
							title: '第一阶段·5课时',
				...
				},
				{
					...
					goodsList: [
						{
							goodsUrl: 'https://cdn.zhangshixuan925.top/web1.jpg',
							title: 'Promise的链式调用',
