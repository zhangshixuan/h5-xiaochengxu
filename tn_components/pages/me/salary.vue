				...
				<view class="one_box">
					...
					<view class="top3">
						<view class="num_two">
							...
							<image class="top3_head" src="https://cdn.zhangshixuan925.top/head2.jpg"></image>
					...
					<view class="top3">
						<view class="num_one">
							...
							<image class="top3_head" src="https://cdn.zhangshixuan925.top/head1.jpg"></image>
					...
					<view class="top3">
						<view class="num_three">
							...
							<image class="top3_head" src="https://cdn.zhangshixuan925.top/head12.jpeg"></image>
	...
	export default {
		data() {
			return {
				nowTime: '',
				rankList: [{
						headimgurl: 'https://cdn.zhangshixuan925.top/head4.jpg',
						name: '张 *',
						post: '全栈工程师',
						city: '深圳',
						salary: '17500'
					}, {
						headimgurl: 'https://cdn.zhangshixuan925.top/head5.jpg',
						name: '李 * 阳',
						post: 'Java后台工程师',
						city: '杭州',
						salary: '17000'
					}, {
						headimgurl: 'https://cdn.zhangshixuan925.top/head6.png',
						name: '吕 * 浩',
						post: 'Web前端工程师',
						city: '西安',
						salary: '16000'
					...
					{
						headimgurl: 'https://cdn.zhangshixuan925.top/head7.jpg',
						name: '张 * 鹏',
						post: 'Web前端工程师',
						city: '西安',
						salary: '15500'
					...
					{
						headimgurl: 'https://cdn.zhangshixuan925.top/head8.jpg',
						name: '李 * 静',
						post: 'Web前端工程师',
						city: '西安',
						salary: '15000'
					...
					{
						headimgurl: 'https://cdn.zhangshixuan925.top/head9.jpg',
						name: '周 * 德',
						post: 'Web前端工程师',
						city: '西安',
						salary: '14000'
					...
					{
						headimgurl: 'https://cdn.zhangshixuan925.top/head10.jpeg',
						name: '赵 *',
						post: 'Web前端工程师',
						city: '西安',
						salary: '13500'
...
<style lang="scss">
	.top_bg {
		width: 750rpx;
		height: 650rpx;
		background: url(https://cdn.zhangshixuan925.top/rank_bg.png) no-repeat;
