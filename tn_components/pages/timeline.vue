		...
		<view class="cu-timeline" v-if="show == 1">
			...
			<view class="cu-item text-blue">
				<view class="content">
					...
					<view class="margin-top">vue+node.js+mongo</view>
					<view class="margin-top-sm">课程时间：3个月左右</view>
					<view class="margin-top-sm">目标：单独完成开发</view>
					<!-- <view class="margin-top-sm">课程费用：3000元/人</view> -->
				</view>
			</view>
			<view class="cu-item text-blue">
				<view class="content">
					...
					<view class="margin-top">Springboot+mybatis</view>
					<view class="margin-top-sm">课程时间：3个月左右</view>
					<view class="margin-top-sm">目标：开发简单的项目</view>
						...
						<view class="cu-timeline">
							...
							<view class="cu-item text-blue">
								<view class="content">
									...
									<view class="margin-top">没有原型，也就是没有业务流程图，无法设计UI图，请先提供完整业务原型，或前往沟通洽谈</view>
								</view>
							</view>
							<view class="cu-item text-blue">
								<view class="content">
							...
							<view class="cu-item text-blue">
								<view class="content">
									...
									<view class="margin-top">根据提供的UI设计需求，双方沟通讨论，并对UI设计需求的合理性和可行性分析，确认无误后，包含图标设计</view>
								</view>
							</view>
